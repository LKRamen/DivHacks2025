...
function SummaryBlock({ summary, profile, spendingData }) {
  ...
  // Label mappings for better AI context
  const GOAL_LABELS = {
    emergency_fund: "Build an emergency fund",
    debt_paydown: "Pay down credit card debt",
    stick_budget: "Stick to a monthly budget",
    cut_spending: "Cut discretionary spending",
    save_purchase: "Save for a big purchase",
    track_subs: "Track & reduce subscriptions",
  };
